...
public class YouTubePage extends PageObject {
  ...
  public static final Target VIDEO_LISTADO_TENDENCIAS= Target.the("Primer Video Listado en la sección de tendencias").locatedBy("//ytd-item-section-renderer[@class='style-scope ytd-section-list-renderer'][1]//ytd-video-renderer[@class='style-scope ytd-expanded-shelf-contents-renderer'][{0}]");
